...
public class ColorSimilarUtils {
    ...
    public static void main(String[] args) {
        String targetColor = "0x2097f3";
        String testColor = "0xc4ac7d";
        // 测试颜色
        Color color1 = Color.decode(targetColor);
        Color color2 = Color.decode(testColor);
        double similarity = calculateSimilarity(color1, color2);

        System.out.println("颜色相似度为：" + similarity);

        // 测试十六进制方法
        double hexSimilarity = calculateSimilarity(targetColor, testColor);

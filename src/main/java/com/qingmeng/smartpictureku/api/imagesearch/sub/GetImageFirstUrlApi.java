...
/**
 * &#064;description: step 2 :获取图片列表接口的api
 *
 * @author Wang
 * &#064;date: 2025/3/12
 */
...
public class GetImageFirstUrlApi {
    ...
    public static void main(String[] args) {
        // 请求目标 URL
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=360464546773963649&sign=126d5e97cd54acd88139901745058968&tpl_from=pc";
